...
const Driving_school_city = () => {
  ...
  const Seaching = async (e, name) => {
    ...
    const result = await API.post("/city_search", Form, { headers: { Authorization: `Bearer ${token}` } });
    setData(result.data.Data);
                      ...
                      getData1(current, size).map((val, i) => {
                        ...
                        return (
                          <tr>
                            ...
                            <td>{val.state_id.state_name}</td>
                            <td>{val.city_name}</td>
                            {/* <td>{val.other_name}</td> */}
                            {/* <td>1</td> */}
                            <td className='text-center'>
                              <Link to={`/view/driving_city/${val._id}`}>
