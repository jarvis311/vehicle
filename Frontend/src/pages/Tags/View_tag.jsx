...
const View_tag = () => {
  ...
  const Getview = async (Eid) => {
      const result = await API.post(`/get_tags_ID/${Eid !== "" ? Eid : id._id}` , {} , {headers: { Authorization: `Bearer ${token}` }});
  ...
  return (
    ...
    <div className="page-heading">
        <h3><Link to="/tag" className='btn btn-primary btn-icon-lg me-3'><i className='bx bxs-left-arrow-alt'></i></Link>View Tags</h3>
