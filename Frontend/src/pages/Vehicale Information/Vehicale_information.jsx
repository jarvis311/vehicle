                                ...
                                <Table bordered responsive>
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="5%">Vehicle ID</th>
                                            <th width="30%">Name</th>
                                            <th width="10%">Price</th>
                                            <th width="10%" >Image</th>
                                            <th width="10%" >Is Upcoming</th>
                                            <th width="10%" >Is Latest</th>
                                            ...
                                            getData1(current, size).map((val, i) => {
                                                ...
                                                return (
                                                    <tr>
                                                        ...
                                                        <td>{val.php_id}</td>
                                                        <td>{`${val.name} ${val.varient_name}`}</td>
                                                        <td>{val.max_price}</td>
                                                        <td>
                                                            <Fancybox>
                                                        ...
                                                        <td>
                                                            <Switch
                                                                ...
                                                                checked={val.upcoming === 1 ? true : false}
                                                                offColor="#C8C8C8"
                                                                onColor="#0093ed"
                                                                name="upcoming"
                                                                height={30}
                                                        ...
                                                        <td>
                                                            <Switch
                                                                ...
                                                                checked={val.latest === 1 ? true : false}
                                                                offColor="#C8C8C8"
                                                                onColor="#0093ed"
                                                                height={30}
                                                                width={70}
