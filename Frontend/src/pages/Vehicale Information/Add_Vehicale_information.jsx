...
var Brand_Array = []
var Body_Type_Array = []
const Add_Vehicale_information = () => {
  ...
  const removeReturnModalColor = (index) => {
    const data = [...Modal_color_Data]
    data.splice(index, 1)
  ...
  const removeReturnPriceVariant = (index) => {
    const data = [...Variant_Price]
    data.splice(index, 1)
  ...
  const Submite = async () => {
    ...
    if (Data.name == undefined || Data.fuel_type == undefined || Data.rating == undefined || Data.review == undefined || Data.min_price == undefined ||
      ...
      Data.price_des == undefined || Data.high_des == undefined || Data.key_specs == undefined || Data.seo_note == undefined || image.length == 0 || thumb_image.length == 0) {
      setvalidated(true)
    } else {
      let count = 0
      ...
      if (count !== 0) {
        ...
        if (count1 !== 0) {
          ...
          Modal_color_Data.forEach((row, index) => {
            console.log('row===>', row.Modal_color_image)
          ...
          const resut = await API.post("/add/vehicleinformation", Form)
          if (resut) {
            toast.success("Data Save Successfully")
            navigate("/Vehicale_information")
          }
        }
      }
    }
  ...
  return (
    <Layout sidebar={true}>
      <div className="page-heading">
        <h3>Vehicle Information Add</h3>
        <Breadcrumb className="d-none d-sm-none d-md-none d-lg-block">
          <Breadcrumb.Item >
            <Link to="/"><i className='bx bx-home-alt me-2 fs-5' ></i> Home</Link>
          </Breadcrumb.Item>
          <Breadcrumb.Item >
            <Link to="/Vehicale_information">Vehicle Information </Link>
          </Breadcrumb.Item>
                                ...
                                <Card.Body>
                                  <Row>
                                    ...
                                    <Col md={2}>
                                      ...
                                      <Switch
                                        onChange={(checked) => { checked === true ? setUpcoming(1) : setUpcoming(0) }}
                                        name="upcoming"
                                        checked={Upcoming === 1 ? true : false}
                                        offColor="#C8C8C8"
                                        onColor="#0093ed"
                                        height={30}
                                        width={70}
                                    ...
                                    <Col md={2}>
                                      ...
                                      <Switch
                                        onChange={(checked) => { checked === true ? setLatest(1) : setLatest(0) }}
                                        name="latest"
                                        checked={Latest === 1 ? true : false}
                                        offColor="#C8C8C8"
                                        onColor="#0093ed"
                                        height={30}
                                        width={70}
                                        ...
                                        <Row>
                                          ...
                                          <Col md={1} className="d-flex align-self-end mb-2 justify-content-end">
                                            <Button
                                              ...
                                              onClick={() => removeReturnModalColor(i)}
                                            >
                                        ...
                                        <Row>
                                          ...
                                          <Col md={1} className="d-flex align-self-end mb-2 justify-content-end">
                                            <Button
                                              variant="danger"
                                              className="btn-icon-lg"
                                              onClick={() => removeReturnPriceVariant(i)}
                                            >
                                              <i class='bx bx-minus' ></i>
                                            </Button>
                                          </Col>
                                          ...
                                          <Col md={3}>
                                            ...
                                            />
                                            <Form.Control.Feedback type="invalid">
                                              Variant Image Field Is Require
                                            </Form.Control.Feedback>
                                          </Col>
...
export default Add_Vehicale_information