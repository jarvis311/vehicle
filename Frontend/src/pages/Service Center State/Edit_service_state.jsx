...
const Getview = async (Eid) => {
  const result = await API.post(`/srevice_get_state_ID/${params.id}` , {} , {headers: { Authorization: `Bearer ${token}` }});
...
const Submite = async()=>{
  if(Data.name == ""){
    ...
    const Result = await API.post(`/srevice_update_state/${params.id}` , Data , {headers: { Authorization: `Bearer ${token}` }})
    if (Result) {
