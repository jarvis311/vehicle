...
const News_headline = () => {
  const token = Cookies.get("fmljwt");
    ...
    const GetData = async () => {
        ...
        console.log('Result', Result?.data?.Data.category_id)
                        ...
                        <Table bordered responsive>
                            <thead>
                                <tr>
                                    ...
                                    <th width="5%" className="text-center">Description</th>
                                    <th width="5%" className="text-center">Date</th>
                                    <th width="5%" className="text-center">Image</th>
                                    <th width="5%" className="text-center">Head Tag</th>
