...
const News_category = () => {
    ...
    const PageGetData = async () => {
      ...
      const Togglechange = async (id, e, name) => {
        ...
        const result = await API.post("/toggle_News_category", Form, { headers: { Authorization: `Bearer ${token}` } });
        if (result) {
      ...
      swalWithBootstrapButtons
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            const form = new FormData()
            form.append('id', id)
            await API.post(`/delete_News_category`, form, { headers: { Authorization: `Bearer ${token}` } });
            GetData();
          } else {
            count = 10
            clearInterval(swalCountdownInterval)
  ...
  return (
    ...
    <div className="page-heading">
      <h3 className="my-1">News Category</h3>
      ...
      <SelectPicker
        ...
        <Link to="/Add/news_category" className="my-1 ms-3">
                      ...
                      return (
                        <tr>
                          ...
                          <a data-fancybox="gallery" href={val.Image}>
                           <img src={val.Image} className="hv-40 rounded-3" alt="Image" />
                         </a>
                          </Fancybox>
                          </td>
                          <td>
