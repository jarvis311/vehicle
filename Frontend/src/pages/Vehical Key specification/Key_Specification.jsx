        ...
        swalWithBootstrapButtons
            ...
            .then(async (result) => {
                if (result.isConfirmed) {
                    ...
                    form.append('id', id)
                    await API.post(`/delete/Key_specification`, form, { headers: { Authorization: `Bearer ${token}` } });
                    GetData();
                } else {
                    count = 10
                    clearInterval(swalCountdownInterval)
  ...
  return (
    <Layout sidebar={true}>
            <div className="page-heading">
                <h3 className="my-1">Key Specification</h3>
                <div className="page-heading-right">
                    ...
                    <Link to="/Add/Key_Specification" className="my-1 ms-3">
                                                ...
                                                return (
                                                    <tr>
                                                        ...
                                                        <td className='text-center'>
                                                            <Link to={`/view/Key_Specification/${val._id}`}>
...
export default Key_Specification